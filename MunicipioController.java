...
public class MunicipioController extends HttpServlet {
    ...
    public void editar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            String nomeDoMunicipio = request.getParameter("municipio_nome");
            Long codigoDoMunicipio = Long.parseLong(request.getParameter("municipio_codigo"));
            Long codigoDaProvincia = Long.parseLong(request.getParameter("provincia_codigo"));
